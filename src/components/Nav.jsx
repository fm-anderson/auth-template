...
export default function Nav() {
  ...
  return (
    <div className="bg-gray-100 font-sans w-full m-0">
      <div className="bg-slate-200 h-20 shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden sm:flex sm:items-center">
              <Link
                to={'/'}
                className="text-gray-800 text-sm font-semibold hover:text-teal-600 mr-4"
              >
                Home
              </Link>
              <Link
            ...
            <div className="hidden sm:flex sm:items-center">
              {!user && (
                <>
                  <Link
                    to={'/login'}
                    className="text-gray-800 text-sm font-semibold hover:text-teal-600 mr-6"
                  >
                    Login
                  </Link>
                  <Link
              ...
              {user && (
                <button
                  className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-teal-600 hover:border-teal-600"
                  onClick={logout}
                >
                  Logout
                </button>
          ...
          <motion.div
            className="block sm:hidden border-t-2 py-2 bg-slate-200"
            initial="exit"
          ...
          >
            <div className="flex flex-col">
              ...
              <div className="flex justify-between items-center border-t-2 pt-2 border-slate-300">
                {!user && (
                  <>
                    <Link
                      to={'/login'}
                      className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-teal-600 hover:border-teal-600"
                    >
                      Login
                    </Link>
                    <Link
